...
DTrain = DBins{1};
LTrain = LBins{1};
XTest  = combineBins(XBins, [2:30]);
DTest  = combineBins(DBins, [2:30]);
LTest  = combineBins(LBins, [2:30]);
...
V0 = randn(numHidden+1,length(unique(L)))/100; % Initialize your weight matrix V
